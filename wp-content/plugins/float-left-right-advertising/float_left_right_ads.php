    ...
    <?php if(empty($is_mobile))://Neu la may tinh ?>
		<script type="text/javascript">
            ...
            if(clientWidth >= <?php echo $screen_w; ?>){
                document.write('<div id="divAdRight" style="position: absolute; top: 0px; width:<?php echo $RightBannerW; ?>px; height:570px; overflow:hidden;"> <?php echo html_entity_decode(get_option('csnv_right_code')); ?></div><div id="divAdLeft" style="position: absolute; top: 0px; width:<?php echo $LeftBannerW; ?>px;height:570px; overflow:hidden;"><?php  echo html_entity_decode(get_option('csnv_left_code')); ?></div>');	
