		...
		?>
			...
			<li class="recent-post-item">
							<?php
								...
								if (strlen($title_post)>100){
	
		 
$x = explode(" ",$title_post);  
//print_r($x);
$y = count($x);  
//if ($y>5){
//echo $y;
...
$title_post=$newlen.'...';  
				...
				<a  href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>" class="post-title"><?php echo $title_post; ?></a>
