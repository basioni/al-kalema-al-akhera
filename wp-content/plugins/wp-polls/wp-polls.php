...
function create_poll_table() {
	...
	'<p style="text-align: center;"><input type="button" name="vote" value="   '.__('تصويت', 'wp-polls').'   " class="Buttons" onclick="poll_vote(%POLL_ID%);" /></p>'.
	'<p style="text-align: center;"><a href="#ViewPollResults" onclick="poll_result(%POLL_ID%); return false;" title="'.__('View Results Of This Poll', 'wp-polls').'">'.__('عرض النتائج', 'wp-polls').'</a></p>'.
	'</div>');
	...
	'<p style="text-align: center;">'.__('عدد المصوتين', 'wp-polls').': <strong>%POLL_TOTALVOTERS%</strong></p>'.
	'</div>');
