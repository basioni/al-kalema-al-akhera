...
function catchbox_widgets_init() {
	...
	register_sidebar( array(
    'name' => __( 'Header Area', 'catchbox' ),
    'id' => 'sidebar-5',
    'description' => __( 'An optional widget area for your site header', 'catchbox' ),
...
function catchbox_footer_content() { ?>
    ...
    <div class="powered">
        <a href="<?php echo esc_url( __( 'http://own-source.com/', 'catchbox' ) ); ?>" title="<?php esc_attr_e( 'Powered by Own Source', 'catchbox' ); ?>" rel="generator"><?php printf( __( 'Powered by %s', 'catchbox' ), 'Own Source' ); ?></a>
