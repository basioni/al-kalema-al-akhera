...
$supernova_defaults[]=array(
		'name'=>__('Remove Top Navigation', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Main Navigation', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Categories From Header', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Footer Background', 'Supernova'),
		'type'=>'color',
		'desc'=>'',
		'id'=> 'footer-color',
		'page'=>__('Styling', 'Supernova'),
...
$supernova_defaults[]=array(
		'name'=>__('Footer Text Color', 'Supernova'),
		'type'=>'color',
		'desc'=>'',
		'id'=> 'footertext-color',
		'page'=>__('Styling', 'Supernova'),
...
$supernova_defaults[]=array(
		'name'=>__('Footer Heading Color', 'Supernova'),
		'type'=>'color',
		'desc'=>'',
...
$supernova_defaults[]=array(
		'name'=>__('Post Paragraph', 'Supernova'),
		'type'=>'color',
		'desc'=>'',
		'id'=> 'post-para-color',
		'page'=>__('Styling', 'Supernova'),
...
$supernova_defaults[]=array(
		'name'=>__('Slide Effect', 'Supernova'),
		'type'=>'select',
...
$supernova_defaults[]=array(
		...
		'type'=>'slider',
		'desc'=>__('Choose Post + Image OR just post which already has featured image.', 'Supernova'),
		'id'=> 'fat1',
		'id2'=>'slider1',
...
$supernova_defaults[]=array(
		'name'=>'Facebook',
		'type'=>'links',
		'desc'=>__('Delete link to remove icon', 'Supernova'),
		'id'=> 'facebook-link',
		'image'=>'facebook.gif',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Sidebar From Home Page', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Turn Off Sticky Navigation', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove dropdown Effect', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Search From Top Navigation', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Search From Main Navigation', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove \'back to top\'', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Pagination', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Breadcrumb', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Font Resizer', 'Supernova'),
		'type'=>'checkbox',
...
$supernova_defaults[]=array(
		'name'=>__('Remove Comments From Pages', 'Supernova'),
		'type'=>'checkbox',
